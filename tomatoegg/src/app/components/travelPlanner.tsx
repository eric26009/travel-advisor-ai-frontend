			...
			<main className="items-center justify-center">
				<div className="flex flex-col w-full px-8">
					...
					<div className="flex flex-wrap border-x border-b rounded-b border-black pb-5 bg-gray-100">
						...
						<div className="w-full md:w-1/2  lg:w-1/2 xl:w-1/2 flex justify-center items-center pt-5 bg-gray-100">
							<button
								className="w-[200px] lg:w-1/2 xl:w-1/2 py-2 px-4 rounded bg-black text-white font-bold border border-transparent hover:bg-white hover:text-black hover:border-black"
								type="button"
								onClick={() => submit()}
							>
								Submit
				...
				{activities && (
					<div className="w-full">
						...
						{activities.map((activitie: any) => {
							return (
								<div className="flex flex-col border border-black rounded mx-8 mt-5 p-3 bg-gray-300">
